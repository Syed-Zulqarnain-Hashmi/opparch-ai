      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
            Access your personalized opportunity discovery, CRM pipeline, and local AI.
          </p>
        </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g. admin@opparch.ai or yourname@gmail.com"
          ...
          <div
            className="pt-4 border-t text-center text-xs flex items-center justify-between"
            style={{ borderColor: 'var(--border-subtle)', color: 'var(--text-muted)' }}
          >
            <span>Don&apos;t have an account?</span>
            <Link href="/register" className="font-bold text-electric-400 hover:underline">
              Register Now
            </Link>
          </div>
        </div>
